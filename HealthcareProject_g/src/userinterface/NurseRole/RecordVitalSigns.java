...
public class RecordVitalSigns extends javax.swing.JPanel {
 ...
 if(txtBodyTemp[JTextField].getText().isEmpty() || txtRespRate[JTextField].getText().isEmpty()
        ...
        {
            try {
                RecordVitalSigns.setManufacturer(txtBodyTemp.getText());
                RecordVitalSigns.setYearOfManufacture(Integer.parseInt(txtRespRate.getText()));
                RecordVitalSigns.setModel(Integer.parseInt(txtPulseRate.getText()));
                RecordVitalSigns.setSerialNumber(Long.parseLong(txtBloodPressure.getText()));
